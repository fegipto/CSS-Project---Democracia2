...
public class Delegate extends Citizen {
     ...
     */
    public void chooseDelegate(Delegate delegate, Topic topic) { super.chooseDelegate(delegate, topic); }
     ...
     */
    public void proposeBill(String title, String description, byte[] file, LocalDateTime validaty, Topic topic) {
