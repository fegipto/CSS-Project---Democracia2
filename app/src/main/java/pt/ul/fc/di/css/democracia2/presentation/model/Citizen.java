...
public class Citizen {
  ...
  public void setChosenDelegate(Delegate delegate, Topic topic) {
    chosenDelegates.put(topic, delegate);
  }

  public Delegate getChosenDelegate(Topic topic) {
    return this.getChosenDelegates().get(topic);
  }

  public boolean delegateExists(Topic topic) {
    return this.getChosenDelegates().containsKey(topic);
  }
